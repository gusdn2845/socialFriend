			...
			<table class="table table-bordered table-hover" style="text-align:center; border:1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" class="form-control" name="userID" maxlength="20" placeholder="아이디"></td>
					</tr>
					<tr>
						<td style="width:110px;"><h5>비밀번호</h5></td>
						<td><input type="password" class="form-control" name="userPassword" maxlength="20" placeholder="비밀번호"></td>
					</tr>
					<tr>
						<td style="text-align:left;" colspan="2"><input class="btn btn-default pull-right" type="submit" value="로그인"></td>
					</tr>	
				</tbody>
			</table>
		</form>

			...
			<table class="table table-bordered table-hover" style="text-align:center;border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td style="width:110px;"><button class="btn btn-default" onclick="registerCheckFunction();" type="button">중복체크</button></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text" id="userEmail" name="userEmail" maxlength="20" placeholder="이메일을 입력하세요"></td>
					</tr>
					<tr>
						<td style="text-align:left;" colspan="3"><h5 style="color:red;" id="passwordCheckMessage"></h5><input type="submit" class="btn btn-primary pull-right" value="등록"></td> 
					</tr>
				</tbody>
			</table>
		</form>

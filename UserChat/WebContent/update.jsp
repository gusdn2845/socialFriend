				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="profileUpdate.jsp">프르필수정</a></li>
			...
			<table class="table table-bordered table-hover" style="text-align:center;border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" onkeyup="passwordCheckFunction();" type="password" id="userPassword2" name="userPassword2" maxlength="20" placeholder="비밀번호확인을 입력하세요"></td>
					</tr>
					<tr>
						...
						<td colspan="2">
							<div class="form-group" style="text-align:center; margin:0 auto">
								<div class="btn-group" data-toggle="buttons">
									<label class="btn btn-default <% if(user.getUserGneder().equals("남자")) out.println("active");%>">
										<input type="radio" name="userGender" value="남자 " <% if(user.getUserGneder().equals("남자")) out.println("checked"); %>>남자
									</label>
									<label class="btn btn-default <% if(user.getUserGneder().equals("여자")) out.println("active");%>">
										<input type="radio" name="userGender" value="여자" <% if(user.getUserGneder().equals("여자")) out.println("checked"); %>>여자
									</label>
								</div>
							</div>
						</td>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text" id="userEmail" name="userEmail" maxlength="20" placeholder="이메일을 입력하세요" value="<%= user.getUserEmail() %>"></td>
					</tr>
					<tr>
						<td style="text-align:left;" colspan="3"><h5 style="color:red;" id="passwordCheckMessage"></h5><input type="submit" class="btn btn-primary pull-right" value="수정"></td> 
					</tr>
				</tbody>
			</table>
		</form>

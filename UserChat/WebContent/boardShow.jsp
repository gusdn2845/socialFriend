	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align:center;border:1px solid #dddddd">
			<thead>
				...
				<tr>
					<td style="vertical-align: middle;background-color:#fafafa; color:#000000;width:80px;"><h5>글 내용</h5></td>
					<td colspan="3"><h5 style="text-align:left;"><%= board.getBoardContent() %></h5></td>
				</tr>
				<tr>

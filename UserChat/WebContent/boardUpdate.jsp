				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="active"><a href="profileUpdate.jsp">프르필수정</a></li>
			...
			<table class="table table-bordered table-hover" style="text-align:center;border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><textarea class="form-control" rows="10" maxlength="2048" name="boardContent" placeholder="글 내용을 입력하세요" ><%=board.getBoardContent() %></textarea></td>
					</tr>
					<tr>

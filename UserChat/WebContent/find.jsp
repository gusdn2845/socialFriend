	...
	<script type="text/javascript">
		...
		function getFriend(findID,userProfile){
			...
			$('#friendResult').html('<thead>'+
				...
				'<h3>'+ findID +'</h3><a href="chat.jsp?toID='+encodeURIComponent(findID)+'" class="btn btn-default pull-right">'+'메시지 보내기</a></td>'+
				'</tr>'+
				'</tbody>');
		}
...
<body>
		...
		<table class="table table-bordered table-hover" style="text-align:center; border:1px solid #dddddd">
			...
			<tbody>
				<tr>
					...
					<td><input type="text" class="form-control" id="findID" maxlength="20" placeholder="찾을 아이디를 입력하세요."></td>
				</tr>
				<tr>
	...
	<div class="container">
		<table id="friendResult" class="table table-hover table-bordered" style="text-align:center; border:1px solid #dddddd">

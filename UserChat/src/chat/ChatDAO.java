...
DataSource dataSource;
	...
	public ArrayList<ChatDTO> getChatListByID(String fromID, String toID,String chatID){ //최근 메세지 불러오기
	...
	public ArrayList<ChatDTO> getChatListByRecent(String fromID, String toID,int number){ //기본적으로 불러올 채팅리스트
		ArrayList<ChatDTO> chatList = null;
		Connection conn = null;
		PreparedStatement pstmt= null;
		ResultSet rs = null;
	...
	public ArrayList<ChatDTO> getBox(String userID){ //기본적으로 불러올 채팅리스트
		ArrayList<ChatDTO> chatList = null;
		Connection conn = null;
		PreparedStatement pstmt= null;
		ResultSet rs = null;

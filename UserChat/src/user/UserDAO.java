...
public class UserDAO {
	...
	public UserDTO getUser(String userID) {
		...
		try {
			...
			if(rs.next()) {
				...
				user.setUserGneder(rs.getString("userGender"));
	...
	public String getProfile(String userID) {
		...
		try {
			...
			if(rs.next() || userID.equals("")) {
				if(rs.getString("userProfile").equals("")) {
					return "http://172.30.1.19:8080/UserChat/images/image.jpg";
				}
				return "http://172.30.1.19:8080/UserChat/upload/"+rs.getString("userProfile");
			}
		}catch (Exception e) {
			e.printStackTrace();
		}finally {
		...
		return "http://172.30.1.19:8080/UserChat/upload/image.jpg";
	}
